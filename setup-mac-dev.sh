...
main() {
    ...
    pip_packages=(powerline-status requests)
...
|                      Hi fellow Developer!                    |
|                                                              |
|      This script will setup your Mac for web development     |
|                                                              |
└──────────────────────────────────────────────────────────────┘"
}
...
url=https://raw.githubusercontent.com/Julianvdg/dotfiles/master/installers/homebrew_installer
...
function change_shell_to_zsh() {
    ...
    if grep --quiet zsh <<< "$SHELL"; then
        success "Oh My Zsh shell already exists."
    else
        user=$(whoami)
...
function configure_git() {
    username="Julian van der Giesen"
    email="julianvandergiesen@hotmail.com"
...
function clone_dotfiles_repo() {
    ...
    if test -e $DOTFILES_REPO; then
        ...
        url=https://github.com/Julianvdg/dotfiles.git
